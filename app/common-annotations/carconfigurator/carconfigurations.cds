...
annotate db.CarConfigurations with {
    ...
    exteriorColorSalesPriceValue               @title               : '{i18n>SalesPrice.value}';
    exteriorColorSalesPriceCurrency            @UI.Hidden;
    interiorColorSalesPriceValue               @title               : '{i18n>SalesPrice.value}';
    interiorColorSalesPriceCurrency            @UI.Hidden;
    roofColorSalesPriceValue                   @title               : '{i18n>SalesPrice.value}';
    roofColorSalesPriceCurrency                @UI.Hidden;
    exteriorColorSalesPriceValue               @Measures.ISOCurrency: exteriorColorSalesPriceCurrency;
    interiorColorSalesPriceValue               @Measures.ISOCurrency: interiorColorSalesPriceCurrency;
    roofColorSalesPriceValue                   @Measures.ISOCurrency: roofColorSalesPriceCurrency;
    modelSalesPriceValue                       @title               : '{i18n>SalesPrice.value}';
    modelSalesPriceCurrency                    @UI.Hidden;
    modelSalesPriceValue                       @Measures.ISOCurrency: modelSalesPriceCurrency;
}
