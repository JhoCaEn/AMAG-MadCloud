...
annotate service.OrderReleases with {
    brand                                      @Common          : {
        Text           : brand.name,
...
annotate service.OrderReleases with @Capabilities: {FilterRestrictions: {
...
annotate service.OrderReleases with @UI: {HeaderInfo: {
