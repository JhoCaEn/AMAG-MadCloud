    ...
    categoryId @Common.ValueList: {
        ...
        Parameters    : [
            ...
            },
            {
                ...
                LocalDataProperty: option.restriction.colorCombination.model.brand_code,
...
annotate service.ModelColorRestrictionOptionRules with @UI: {HeaderInfo: {
    $Type         : 'UI.HeaderInfoType',
    TypeName      : '{i18n>RestrictionRule}',
    TypeNamePlural: '{i18n>RestrictionRules}'
}};

annotate service.ModelColorRestrictionOptionRules with @Capabilities: {FilterRestrictions: {
