...
service ReplicationMasterdataTestService {
    ...
    function testOrderControl(vehicleUsage : db.VehicleUsages:code, customerState : db.CustomerStates:code, endCustomerState : db.EndCustomerStates:code) returns String;
    function testStaticOrderControl()                                                                                                                     returns String;
}
